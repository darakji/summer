...
output_excel = os.path.join(base_dir, "MACE_T2_w1_predictions_onT1.xlsx")
model_path = "/home/phanim/harshitrawat/summer/mace_T2_w1_2heads_final_compiled.model"
...
all_cif_files = []
for folder in ["mdcifs", "mdcifs_strained_perturbed", "mdcifs_strained_perturbed_prime"]:
...
output_json = os.path.join(base_dir, "MACE_T2_w1_predictions_onT1.json")
import json
