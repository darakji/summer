...
output_excel = os.path.join(base_dir, "MACE_T2_w2_predictions_onT1.xlsx")
model_path = "/home/phanim/harshitrawat/summer/mace_T2_w2_2heads_final_compiled.model"
...
output_json = os.path.join(base_dir, "MACE_T2_w2_predictions_onT1.json")
import json
