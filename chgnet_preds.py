...
# === Config ===
folders = {
    "/home/phanim/harshitrawat/summer/md/mdcifs": "/home/phanim/harshitrawat/summer/md/mdinfo_chgnet_predictions_forces.xlsx",
    "/home/phanim/harshitrawat/summer/md/mdcifs_strained_perturbed": "/home/phanim/harshitrawat/summer/md/strain_perturb_chgnet_predictions_forces.xlsx"
}
...
def extract_info_from_cif(cif_path):
    try:
        ...
        return {
            ...
            "energy_eV": energy,
            "forces_per_atom_eV_per_A": json.dumps(forces.tolist()),  # store as JSON string
            "stress_tensor": json.dumps(stress),  # JSON for 3x3 matrix
            "magmom_total": magmom,
        }
