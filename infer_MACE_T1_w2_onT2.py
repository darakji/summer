...
MODEL_PATH = os.path.join(BASE_DIR, "mace_T1_w2_2heads_final_compiled.model")

DEVICE = "cuda:0"
HEAD = "target_head"

OUTPUT_DIR = os.path.join(BASE_DIR, "md")
OUTPUT_JSON = os.path.join(OUTPUT_DIR, "MACE_T1_w2_predictions_onT2T3.json")
OUTPUT_EXCEL = os.path.join(OUTPUT_DIR, "MACE_T1_w2_predictions_onT2T3.xlsx")
